...
export const BrandsControlsBar = ({
  ...
  const handleViewAllProducts = () => {
    ...
    // TODO: wire to analytics infra when available
    onViewAllProducts();
  };
  ...
  return (
    <div className="brands-controls-bar" id="brands-controls-bar">
      ...
      <div className="brands-controls-search">
        <div className="relative w-full">
          ...
          <Input
            ...
            aria-label={t("brands.searchAriaLabel")}
          />
          {!searchQuery && (
          ...
          {searchQuery && (
            <button
              ...
              aria-label={t("brands.clearSearch")}
            >
              <X className="h-4 w-4" />
            </button>
          )}
      ...
      <div className="brands-controls-right">
        ...
        >
          <span className="hidden sm:inline">{t("brands.viewAllProducts")}</span>
          <span className="sm:hidden">{t("brands.viewAllProductsShort")}</span>
        ...
        <div className="flex border border-border rounded-lg overflow-hidden h-9">
          <button
            ...
            aria-label={t("brands.viewCards")}
            title={t("brands.viewCards")}
          >
          ...
          <button
            ...
            aria-label={t("brands.viewCompact")}
            title={t("brands.viewCompact")}
          >
