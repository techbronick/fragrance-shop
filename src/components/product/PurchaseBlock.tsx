    ...
    <div className="space-y-6">
      ...
      {selectedSku && oos && (
        <a
          ...
          className="w-full inline-flex items-center justify-center gap-2 rounded-md bg-[#25D366] hover:bg-[#1ebe5b] text-white text-body font-medium px-4 py-3 transition-colors duration-instant ease-default"
        >
