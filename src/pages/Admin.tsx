                                      ...
                                      {product.stock_volume > 0 && (
                                        <div className="mb-3 p-3 bg-background/50 rounded-lg border">
                                          <div className="text-sm font-medium mb-2 flex items-center gap-2">
                                            ...
                                            Stock: {product.stock_volume} ml
                                          </div>
                                          <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
                                            {[2, 3, 5, 10, 50, 100].map((bottleSize) => {
                                              const count = Math.floor(product.stock_volume / bottleSize);
                                              return (
                                                <div
                                                  key={bottleSize}
                                                  className="text-center p-2 bg-muted rounded border"
                                                >
                                                  <div className="text-sm font-bold">{count}</div>
                                                  <div className="text-[10px] text-muted-foreground">{bottleSize}ml</div>
                                                </div>
                                              );
                                            })}
                                          </div>
